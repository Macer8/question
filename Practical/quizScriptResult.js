...
const questions = 
[
	new Question("Какие из зарезервированных слов не используются?", 
	[
		new Answer("goto, const", 1),
		new Answer("goto", 0),
		new Answer("const", 0),
		new Answer("Я не знаю", 0)
	]),

	new Question("Какой тип данных не является примитивным?", 
	[
		new Answer("float", 0),
		new Answer("string", 1),
		new Answer("bloolean", 0),
		new Answer("var", 0)
	]),
